...
EditorLayer::EditorLayer() : Lambix::lbLayer("Lambix Editor")
{
}
...
void EditorLayer::OnUpdate(Lambix::lbTimestep ts)
{
	m_FrameBuffer->Bind();
...
void EditorLayer::OnEvent(Lambix::Event &event)
{
}
